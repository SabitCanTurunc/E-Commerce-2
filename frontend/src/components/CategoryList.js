...
const CategoryList = () => {
  ...
  return (
    <div className='container mx-auto p-4 bg-slate-600 rounded-lg m-4'>
                    ...
                    categoryProduct.map((product,index)=>{
                        return(
                            <Link to={"/product-category?category="+product?.category} className='cursor-pointer  ' key={product?.category}>
                                <div className='bg-white hover:bg-black hover:scale-100 rounded-full p-2'>
                                ...
                                <p className='text-center text-sm md:text-base capitalize text-white'>{product?.category}</p>
